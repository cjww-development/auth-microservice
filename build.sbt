...
lazy val scoverageSettings = Seq(
  ScoverageKeys.coverageExcludedPackages := "<empty>;Reverse.*;models/.data/..*;views.*;models.*;common.*;utils.*;.*(AuthService|BuildInfo|Routes).*",
...
lazy val microservice = Project(appName, file("."))
  ...
  .settings(
    ...
    dockerCommands                                :=  Seq(
      ...
      Cmd("USER", "daemon"),
      Cmd("ENTRYPOINT", """["/opt/docker/bin/auth-microservice"]"""),
      Cmd("CMD", """[]""")
    )
  )
